...
#define SYS_ACMPCR2_P8K2_Pos		9		//1 ACMP0、ACMP1、ACMP2的P端经8.2K电阻相连，相连点电平替代VREF电平作为它们的N端输入
...
#define DAC_CR_TRGEN_Pos			4		//0 无需触发，写入DHR的值立即输出
#define DAC_CR_TRGEN_Msk			(0x01 << DAC_CR_TRGEN_Pos)
#define DAC_CR_TRGSEL_Pos			5		//0 写SWTRG触发   1 DAC_TRG引脚上升沿触发   2 下降沿   3 双边沿   4 Timer0触发   5 Timer1触发
